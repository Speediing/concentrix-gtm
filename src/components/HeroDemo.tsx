  ...
  return (
    <>
      <div className="hero-copy">
        <p className="eyebrow">A fleet of agents for every Concentrix team</p>
        <h1>The agents that keep client work moving.</h1>
        <p className="hero-intro">
          Grok Bot follows approved calls, inboxes, and project tools in the
          background. The work starts from a signal, not another prompt.
        </p>
